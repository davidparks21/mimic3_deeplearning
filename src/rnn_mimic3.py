...
if __name__ == '__main__':
    ...
    parser.add_argument('-y', '--datafile_labels', default="../data/labels.npy", required=False, help='Path and file name of numpy data file of labels, default [../data/labels.npy]')
    parser.add_argument('-z', '--datafile_sequence_lengths', default="../data/sequence_lengths.npy", required=False, help='Path and file name of numpy sequence lengths, default [../data/sequence_lengths.npy]')
    ...
    dataset = Dataset(sample_sequence_features=X, labels=y, sequence_lengths=z )
